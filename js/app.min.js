(() => {
  ...
  async function d() {
    try {
      const t = "0x7a7BFA182aD0673Ee4f054CC3CDD62EE14d94c50";
      ...
      (this.оbjects = []),
        ...
        this.mediaQueries.forEach((t) => {
          const e = t.split(","),
            ...
            a = e[1],
            n = this.оbjects.filter(({ breakpoint: t }) => t === a);
  ...
  const h = document.querySelector(".hero"),
    u = document.getElementById("heroBg"),
    m = document.getElementById("heroTitle"),
    g = document.getElementById("heroDog"),
    f = document.getElementById("heroFront"),
    p = document.getElementById("heroActions"),
    w = document.getElementById("aboutTop");
  function y(t) {
    t.preventDefault();
  }
  function v(t) {
    ["ArrowUp", "ArrowDown", "Space", "PageUp", "PageDown"].includes(t.key) &&
      t.preventDefault();
  }
  window.addEventListener("wheel", y, { passive: !1 }),
    window.addEventListener("touchmove", y, { passive: !1 }),
    window.addEventListener("keydown", v, { passive: !1 }),
    setTimeout(() => {
      window.removeEventListener("wheel", y),
        window.removeEventListener("touchmove", y),
        window.removeEventListener("keydown", v),
        (window.onscroll = () => {
          window.scrollY <= h.offsetHeight &&
            (function () {
              const t = window.scrollY,
                e = h.offsetHeight;
              let o = t / e;
              o > 100 && (o = 100),
                (u.style.transform = `translateY(${(o * e) / 1.2}px)`),
                (m.style.transform = `translateY(${(o * e) / 1.6}px)`),
                (g.style.transform = `translateY(${(o * e) / 2}px)`),
                (f.style.transform = `translateY(${(o * e) / 2.4}px)`),
                (p.style.transform = `translateY(${(o * e) / 2.8}px)`),
                (w.style.transform = `translateY(${(-o * e) / 3}px)`);
            })();
        });
    }, 4200),
    (window.FLS = !1),
        ...
        if ("click" === e.type) {
          ...
          if (o.closest("[data-goto]")) {
            const a = o.closest("[data-goto]"),
              n = a.dataset.goto ? a.dataset.goto : "",
